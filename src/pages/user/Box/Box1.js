    ...
    <div className="product-detail">
      ...
      <section className="product-info">
        ...
        <div className="product-image">
          <img
            src="https://media.bizwebmedia.net/sites/103281/data/Upload/2015/5/floral_wedding_invitations.jpg"
            alt="Product Main"
            onClick={() => handleClickImage("https://media.bizwebmedia.net/sites/103281/data/Upload/2015/5/floral_wedding_invitations.jpg")}
          />
        </div>
      </section>
